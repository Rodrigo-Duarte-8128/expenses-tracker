...
class NewRecurringTransactionOptionsScreen(MDScreen):
    def __init__(self, app, **kwargs):
        super(NewRecurringTransactionOptionsScreen, self).__init__(**kwargs)
        ...
        self.start_date = app.new_recurring_transaction_screen.start_date
        self.end_date = app.new_recurring_transaction_screen.end_date
        ...
        self.scroll_layout = MDGridLayout(
            cols=1,
            size_hint_y = None,
            size = (self.window_width, self.window_height * 0.365),
        )
        ...
        if app.new_recurring_transaction_screen.chosen_account_label in app.new_recurring_transaction_screen.layout.children:
            num_name = app.new_recurring_transaction_screen.chosen_account_label.text
    ...
    def account_pressed(self, account):
        def press(instance):
            ...
            if self.app.new_recurring_transaction_screen.error_account_label in self.app.new_recurring_transaction_screen.layout.children:
                self.app.new_recurring_transaction_screen.layout.remove_widget(self.app.new_recurring_transaction_screen.error_account_label)
    ...
    def confirm_options(self, app):
        def confirm(instance):
            ...
            if not errors:
                new_start_date = app.new_recurring_transaction_screen.start_date.parse_string(f"{start_simple_date} 00:00:00")
                app.new_recurring_transaction_screen.start_date = new_start_date

                if end_simple_date != "":
                    new_end_date = app.new_recurring_transaction_screen.start_date.parse_string(f"{end_simple_date} 00:00:00")
                else:
                    new_end_date = None

                app.new_recurring_transaction_screen.end_date = new_end_date

                app.new_recurring_transaction_screen.note = note

                app.new_recurring_transaction_screen.chosen_account_label.text = self.chosen_account_label.text
                if app.new_recurring_transaction_screen.chosen_account_label not in app.new_recurring_transaction_screen.layout.children:
                    app.new_recurring_transaction_screen.layout.add_widget(app.new_recurring_transaction_screen.chosen_account_label)

                app.switch_screen("new_recurring_transaction_screen")(instance)
                app.transition_diagram.remove_node("new_recurring_transaction_options_screen")
                app.screen_manager.remove_widget(app.new_recurring_transaction_options_screen)
