...
class AddIncomeOptionsScreen(MDScreen):
    def __init__(self, app, **kwargs):
        super(AddIncomeOptionsScreen, self).__init__(**kwargs)
        ...
        self.date = app.add_income_screen.date
        ...
        if app.add_income_screen.chosen_account_label in app.add_income_screen.layout.children:
            num_name = app.add_income_screen.chosen_account_label.text
    ...
    def account_pressed(self, account):
        def press(instance):
            ...
            if self.app.add_income_screen.error_account_label in self.app.add_income_screen.layout.children:
                self.app.add_income_screen.layout.remove_widget(self.app.add_income_screen.error_account_label)
    ...
    def confirm_options(self, app):
        def confirm(instance):
            ...
            if not errors:
                new_date = app.add_income_screen.date.parse_string(f"{date} {time}")
                app.add_income_screen.date = new_date
                app.add_income_screen.note = note

                app.add_income_screen.chosen_account_label.text = self.chosen_account_label.text
                if app.add_income_screen.chosen_account_label not in app.add_income_screen.layout.children:
                    app.add_income_screen.layout.add_widget(app.add_income_screen.chosen_account_label)

                app.switch_screen("add_income_screen")(instance)
                app.transition_diagram.remove_node("add_income_options_screen")
                app.screen_manager.remove_widget(app.add_income_options_screen)
